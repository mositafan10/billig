    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_number', models.CharField(blank=True, max_length=24, null=True, validators=[django.core.validators.RegexValidator(message='شماره شبا نامعتبر است', regex='^\\d{1,24}$'), django.core.validators.RegexValidator(message='شماره شبا می\u200cبایست ۲۴ رقم باشد', regex='^.{24}$')])),
